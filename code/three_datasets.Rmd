---
title: "Produce the three datasets" 
author: "Jae Yeon Kim"
date: "`r Sys.Date()`"
editor_options: 
...
pacman::p_load(here, # reproducibility
               ...
               # data visualization 
               ggsci,
               jtools, # make sure dependencies get installed; the same for rlang
               broom.mixed,
               modelsummary,
               hrbrthemes,
               ggpubr,
...
```{r}
ggsave(file = here("plots", "immigrants_name.jpg"), width = 12, height = 11, units = "in")
...
ggsave(file = here("plots", "omnibus_name.jpg"), width = 12, height = 11, units = "in")
...
ggsave(file = here("plots", "perceptions_name.jpg"), width = 12, height = 11, units = "in")
```
...
ggsave(file = here("plots", "immigrants_name_covariate.jpg"), width = 12, height = 11, units = "in")
...
ggsave(file = here("plots", "omnibus_name_covariate.jpg"), width = 12, height = 11, units = "in")
```

```{r}
df2plot_all(df)

ggsave(here("plots", "all_name.jpg"), width = 12, height = 11, units = "in")
```
...
ggsave(here("plots", "all_name_pooled.jpg"), width = 8, height = 7, units = "in")

# for publication
ggsave(here("plots", "figure2.eps"), width = 8, height = 7, units = "in",
       device = "eps")
```
